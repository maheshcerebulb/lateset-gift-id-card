                    ...
                    <div class="card shadow-soft border-light">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex mb-4">
                                ...
                                <a href="#" class="text-black text-hover-primary profile-span-value w-50">{{Auth::user()->company_name}}</a>
                ...
                <div class="card border shadow-soft border-light">
                    ...
                    <div class="card-header align-items-center d-flex justify-content-between border-0 py-5">
                        ...
                        <div class="card-toolbar">
                            ...
                            <a href="{{ url('entity/recentApplications')}}" class="btn btn-info font-weight-bolder font-size-sm">View All</a>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="text-muted font-weight-bold">{{ $row->application_number }}</span></td>
                                                ...
                                                <td class="text-right pr-0">
                                                    ...
                                                    <span class="label label-sm label-inline width-max-content {{ Helper::getApplicationStatusBackgroundColor($row->status) }}" style="width:max-content;">{{ Helper::getApplicationType($row->status)}}</span>
            ...
            {!! Form::model($userDetails, ['route' => 'users.update-entity-profile', 'method' => 'POST', 'class' => 'form', 'id' => 'update_entity_profile_form']) !!}
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-form-label text-right col-lg-3 col-sm-12">Entity Name</label>

                        <div class="col-lg-9 col-md-9 col-sm-12">

                            <div class="input-group" data-z-index="6">

                            {!! Form::text('company_name', null, ['class' => 'form-control required', 'placeholder' => 'Entity Name', 'maxlength' => '255']) !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12">
                            ...
                            <div class="input-group" data-z-index="6">
                                ...
                                {!! Form::text('company_address', null, ['class' => 'form-control required', 'placeholder' => 'Address', 'maxlength' => '100']) !!}
