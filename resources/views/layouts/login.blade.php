...
<html lang="en" >
    ...
    <head>
        ...
        <link href="{!! asset('css/login-4.css?v=7.0.5') !!}" rel="stylesheet" type="text/css" />
		<!--end::Page Custom Styles-->
        <!--begin::Global Theme Styles(used by all pages)-->
        <link href="{!! asset('css/plugins.bundle.css?v=7.0.5') !!}" rel="stylesheet" type="text/css" />
        <link href="{!! asset('css/prismjs.bundle.css?v=7.0.5') !!}" rel="stylesheet" type="text/css" />
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled page-loading">
        ...
        <script src="{!! asset('js/login-general.js?v=7.0.5') !!}" type="text/javascript" ></script>
        @yield('script')
        <!--end::Page Scripts-->
