...
<div style="margin-top:0px;margin-bottom:0px;border:1px solid #B27938;height: 200px;width: 320px;box-sizing: border-box;overflow: hidden;position: relative;padding: 0px;border-radius:5px;">
    <div style="padding:0px 5px;">
        <p style="margin:0px;">
            <span style="color:#000000;font-weight: bold;font-size:6px;">
                General Instruction
            </span>
        </p>
    </div>
    <div style="border-top:0px;line-height:5px;color:#000000;padding-left:10px;">
    ...
    <div style="border-top:1px solid #B27938;color:#000000;">
        <table style="color: #000000;font-size: 5px;padding: 0px 0px;line-height:2px;width:100%;padding:0px 0px;">
            <tbody>
                <tr>
                    <th style="text-align:left;width:40% !important;font-size: 5px;color: #000000;">Mobile No. of Permit Holder : </th>
                    <td style="font-size: 5px;color: #000000;">{{ !empty($row->dial_code) ? '+'.$row->dial_code.' ' : '' }}{{ $row->mobile_number }}</td>
                </tr>
            </tbody>
        </table>
    </div>
