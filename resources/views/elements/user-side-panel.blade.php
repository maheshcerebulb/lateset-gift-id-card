<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
	...
	<div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
		<h3 class="font-weight-bold m-0">{{Auth::user()->fullname}}</h3>
	...
	<div class="offcanvas-content pr-5 mr-n5">
		...
		<div class="d-flex align-items-center mt-5">
			<div class="image-input image-input-outline" id="EntityProfileImageChange">
				<div class="image-input-wrapper" style="background-image: url({{ !empty(Auth::user()->image) ? asset('upload/entity-data/entity-profile/'.Auth::user()->image) : asset('img/user-avatar.png') }});"></div>
			...
			<input type="file" name="entityProfileImage" id="entityProfileImage" style="display:none;">
			<div class="d-flex flex-column">
				<a href="javascript:;" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{Session::get('User.name')}}</a>
				<div class="navi mt-2">
		...
		<div class="navi navi-spacer-x-0 p-0">
			{{-- <!--begin::Item-->data-target="#staticBackdrop" data-toggle="modal"  --}}
			<a href="{{route('welcome')}}" class="navi-item">
				<div class="navi-link">
					<div class="symbol symbol-40 mr-3">
						<div class="symbol-label bg-success-o-50">
			...
			<a href="{{route('users.profile')}}" class="navi-item">
				<div class="navi-link">
					<div class="symbol symbol-40 mr-3">
            ...
            <a href="{{route('users.change-password')}}" class="navi-item">
				<div class="navi-link">
					<div class="symbol symbol-40  mr-3">
						<div class="symbol-label bg-warning-o-50">
