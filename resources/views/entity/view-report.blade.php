...
@section('scripts')
    ...
    $(document).ready(function() {
        var table = $('#application_table').DataTable({
            ...
            serverSide: true,
            /*var statusOptions = {
                Admin: ['ALL','Activated', 'Blocked', 'Expired','Terminated','Hard copy submitted','Rejected','Verified'],
                Sub Admin: ['ALL','Surrendered','Activated','Send Back', 'Blocked', 'Expired','Terminated','Hard copy submitted','Submited','Rejected','Verified']
            },*/
